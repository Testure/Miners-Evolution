...
local Size = Vector3.new(0.8,0.8,0.8) -- Size of the drops
local Material = Enum.Material.Granite -- Material of the drops
local Color = BrickColor.new("Dark stone grey").Color -- Color of the drops
local OreValue = MoneyLib.STV("450K") -- Value of the drops
