...
if Server then
	script.Upgrade.OnServerEvent:Connect(function(Player,Ore)
		...
		if Ore.Name == "Ancient Mine" then
			Ore.Cash.Value = (Ore.Cash.Value * 5)
		elseif Ore.Material == Enum.Material.Slate then
			Ore.Cash.Value = (Ore.Cash.Value * 2)
		end
		Ore.Cash.Value = (Ore.Cash.Value * 20)
	end)
end
