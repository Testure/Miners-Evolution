...
local CoolDown = 1.7 -- Interval in seconds between drops
local Size = Vector3.new(1,1,1) -- Size of the drops
local Material = Enum.Material.Sand -- Material of the drops
local Color = BrickColor.new("Daisy orange").Color -- Color of the drops
local OreValue = MoneyLib.STV("100K") -- Value of the drops
