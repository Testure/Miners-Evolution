			...
			if Player then
				...
				if Chance == 2 then
					...
					if Chance == 17 then
						...
						game.ReplicatedStorage.Currency:FireClient(Player,script.Parent,"+1 Rare Box",Box.Color.Value,3,"131144461")
						game.ReplicatedStorage.CurrencyNotify:FireClient(Player,"Rare Box",Box.Color.Value,Box.Image.Value)
