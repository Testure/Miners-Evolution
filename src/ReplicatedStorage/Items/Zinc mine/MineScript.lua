...
local CoolDown = 2.8 -- Interval in seconds between drops
local Size = Vector3.new(1.5,1.5,1.5) -- Size of the drops
local Material = Enum.Material.Slate -- Material of the drops
local Color = BrickColor.new("Fog").Color -- Color of the drops
local OreValue = MoneyLib.STV("150K") -- Value of the drops
